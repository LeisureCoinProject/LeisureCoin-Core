...
Intro
-----
LeisureCoin (LeisureCoin) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. LeisureCoin utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run LeisureCoin-qt.exe.

LeisureCoin Core is the original LeisureCoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of LeisureCoin transactions;
