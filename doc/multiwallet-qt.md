...
In order to support loading of multiple wallets in LeisureCoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is LeisureCoin.cpp.
...
Changes to LeisureCoin.cpp
----------------------
LeisureCoin.cpp is the entry point into LeisureCoin-qt, and as such, will require some minor modifications to provide hooks for
