...
#   c) node1 mines 32 blocks, so now node 0 has 500000LeisureCoin, node 1 has 4250LeisureCoin, node2 has none.
#   d) node0 sends 601 LeisureCoin to node2, in two transactions (301 LeisureCoin, then 300 LeisureCoin).
