...
HEADERS += src/bignum.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/LeisureCoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/LeisureCoin-cli.cpp \
           src/LeisureCoin-tx.cpp \
           src/LeisureCoin.cpp \
           src/db.cpp \
           ...
           src/qt/LeisureCoin.cpp \
           src/qt/LeisureCoinstrings.cpp \
...
RESOURCES += src/qt/LeisureCoin.qrc src/qt/LeisureCoin_locale.qrc

TRANSLATIONS += src/qt/locale/LeisureCoin_bg.ts \
                src/qt/locale/LeisureCoin_de.ts \
                src/qt/locale/LeisureCoin_en.ts \
                src/qt/locale/LeisureCoin_es.ts \
                src/qt/locale/LeisureCoin_fi.ts \
                src/qt/locale/LeisureCoin_fr.ts \
                src/qt/locale/LeisureCoin_it.ts \
                src/qt/locale/LeisureCoin_ja.ts \
                src/qt/locale/LeisureCoin_pl.ts \
                src/qt/locale/LeisureCoin_pt.ts \
                src/qt/locale/LeisureCoin_ru.ts \
                src/qt/locale/LeisureCoin_sk.ts \
                src/qt/locale/LeisureCoin_sv.ts \
                src/qt/locale/LeisureCoin_vi.ts \
                src/qt/locale/LeisureCoin_zh_CN.ts \
                src/qt/locale/LeisureCoin_zh_TW.ts
