...
VERSION=
commit=false
url=https://github.com/LeisureCoin-official/LeisureCoin
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/LeisureCoin-official/LeisureCoin
