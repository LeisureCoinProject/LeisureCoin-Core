Contributing to LeisureCoin Core
==================================

The LeisureCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LeisureCoin Core project, and is not to be
confused with overall LeisureCoin Network Protocol consensus changes.

Whether a pull request is merged into LeisureCoin Core rests with the project merge
...
Patches that change LeisureCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the LeisureCoin consensus, it must have been
...
The project leader is the release manager for each LeisureCoin Core release.
