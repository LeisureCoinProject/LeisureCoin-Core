...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::LeisureCoin);
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in LeisureCoin.cpp during shotdown to also remove the window positions
