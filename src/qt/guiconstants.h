...
/* LeisureCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LeisureCoin"
#define QAPP_ORG_DOMAIN "LeisureCoin.org"
#define QAPP_APP_NAME_DEFAULT "LeisureCoin-Qt"
#define QAPP_APP_NAME_TESTNET "LeisureCoin-Qt-testnet"
