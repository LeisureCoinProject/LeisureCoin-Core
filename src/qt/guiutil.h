...
/** Utility functions used by the LeisureCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render LeisureCoin addresses in monospace font
...
// Parse "LeisureCoin:" URI into recipient object, return true on successful parsing
