...
#if defined(NDEBUG)
#error "LeisureCoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uPARK) are considered zero fee (for relaying and mining)
...
{
    RenameThread("LeisureCoin-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // LeisureCoin: We use certain sporks during IBD, so check to see if they are
