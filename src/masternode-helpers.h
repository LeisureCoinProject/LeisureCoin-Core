...
// Copyright (c) 2017-2018 The LeisureCoin developers
...
public:
    ...
    /// Is the inputs associated with this public key? (and there is LeisureCoin collateral - checking if valid masternode)
