...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"LeisureCoin", "masternodebroadcast", &masternodebroadcast, true, true, false},
        ...
        {"LeisureCoin", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"LeisureCoin", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"LeisureCoin", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"LeisureCoin", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"LeisureCoin", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"LeisureCoin", "mncommunityvote", &mncommunityvote, true, true, false},
