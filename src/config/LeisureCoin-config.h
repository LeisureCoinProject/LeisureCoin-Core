/* src/config/LeisureCoin-config.h.  Generated from LeisureCoin-config.h.in by configure.  */
/* src/config/LeisureCoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LeisureCoin_CONFIG_H

#define LeisureCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.LeisureCoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LeisureCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LeisureCoin Core 1.3.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "LeisureCoin"
